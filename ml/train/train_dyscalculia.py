"""
Training script for the Dyscalculia risk classifier (NeuroGen Suite).
...
Run from the project root:
    python ml/training/train_dyscalculia.py
"""
...
DATA_PATH = PROJECT_ROOT / "ml" / "data" / "dyscalculia_dataset.csv"
MODEL_PATH = PROJECT_ROOT / "ml" / "models" / "dyscalculia.pkl"
...
NUMERIC_FEATURES = [
    "age",
    "subitizingThreshold",
    "symbolicMappingSpeed",
    "symbolicMappingErrors",
    "faceDetectedRatio",
...
CATEGORICAL_FEATURES = ["subitizingFailed", "cameraAvailable"]
