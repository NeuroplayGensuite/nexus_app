"""
Training script for the Dyspraxia risk classifier (NeuroGen Suite).
...
Run from the project root:
    python ml/training/train_dyspraxia.py
"""
...
DATA_PATH = PROJECT_ROOT / "ml" / "data" / "dyspraxia_dataset.csv"
MODEL_PATH = PROJECT_ROOT / "ml" / "models" / "dyspraxia.pkl"
