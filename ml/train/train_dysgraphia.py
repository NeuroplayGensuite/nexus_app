"""
Training script for the Dysgraphia risk classifier (NeuroGen Suite).
...
Run from the project root:
    python ml/training/train_dysgraphia.py
"""
...
DATA_PATH = PROJECT_ROOT / "ml" / "data" / "dysgraphia_dataset.csv"
MODEL_PATH = PROJECT_ROOT / "ml" / "models" / "dysgraphia.pkl"
