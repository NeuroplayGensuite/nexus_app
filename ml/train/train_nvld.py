"""
Training script for the NVLD (Nonverbal Learning Disability) risk
classifier (NeuroGen Suite).
...
Run from the project root:
    python ml/training/train_nvld.py
"""
...
DATA_PATH = PROJECT_ROOT / "ml" / "data" / "nvld_dataset.csv"
MODEL_PATH = PROJECT_ROOT / "ml" / "models" / "nvld.pkl"
