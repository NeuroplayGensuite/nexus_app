...
// API Keys - Groq is primary, Gemini is fallback
...
// Groq API with latest Llama 3.3 70B model
const GROQ_API_URL = 'https://api.groq.com/openai/v1/chat/completions';
const GROQ_MODEL = 'llama-3.3-70b-versatile'; // Latest and most capable

// Gemini as fallback
const GEMINI_API_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-exp:generateContent';

// Helper function to call Groq API (Primary)
...
// Unified AI call with fallback chain: Groq -> Gemini -> Local
